        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="mt-8 text-4xl md:text-6xl font-bold leading-tight text-white">
              Turning Ideas Into <span className="text-neon">Modern Digital Products</span>
            </h2>

            {/* Description */}
            <p className="mt-8 text-muted-foreground text-lg leading-relaxed max-w-xl">
              I create visually stunning and high-performance web applications focused on clean
              design, smooth user experience, and scalable development solutions.
            </p>

            <p className="mt-6 text-muted-foreground text-lg leading-relaxed max-w-xl">
              From modern frontend interfaces to powerful full-stack systems, I enjoy building
              products that combine creativity with functionality using the latest technologies.
            </p>
            ...
            <div className="mt-12 grid grid-cols-3 gap-6">
              {stats.map((item, index) => (
                ...
                >
                  <h3 className="text-4xl font-bold text-neon">{item.number}</h3>
